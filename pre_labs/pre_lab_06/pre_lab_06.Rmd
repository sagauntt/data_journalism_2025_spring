...
**Answer**No.The total columns in 2022 is title case while all other years are uppercase. And the 2024 dataset has no "GRN" column 
...
**Answer** There are now 24 rows, and that's how many there should be since we are using a left join and the county voters 2020 data has 24 rows. 
...
**Answer** It says "Joining with `by = join_by(COUNTY)`"
...
**Answer** Prince George's County has the highest percentage of all Maryland counties at 60.9 percent. About 78.3 percent of its residents are Democrats. 
...
**Answer**Howard County has the highest percentage of its 18+ population being Asian, at 19.3 percent. About 52.4 percent of its residents are Democrats. Compared to the previous results, both percentages are lower. The top counties are also quite different, with Howard and Montgomery now taking the top two spots. 
...
**Answer**ZCTA5N has a datatype of <dbl>, showing that it is a numeric column. 
...
**Answer**ZCTA5N is now a charater datatype. 
