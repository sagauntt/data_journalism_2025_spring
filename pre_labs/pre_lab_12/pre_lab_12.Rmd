...
**Answer** There are two columns, Date and News releases, which show the date published and title of each news release. 
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer** I think it could be useful to add information such as length of the title or type of announcement. 
...
tags. Describe the output: **Answer** Each list item shows a different page/link on the website, such as link to the Facebook account or the link to the leadership page. 
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer**Now we have a dataframe with the results above. 
