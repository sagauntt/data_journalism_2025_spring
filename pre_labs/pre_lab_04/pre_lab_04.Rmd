...
**Answer** For some of the grantees, there are entries slight differentiation in the listed name, such as "WALTER P CARTER CHILD CARE CENTER"	vs "WALTER P CARTER CHILD CARE CENTER INC," which results in a new grantee being added, rather than being grouped together. 
...
**Answer**The refinr package made several changes, including shifting "Charles County Arts Alliance Inc" to "CHARLES COUNTY ARTS ALLIANCE" and changing "Rise Therapeutics" to "RISE THERAPEUTICS LLC."
...
**Answer** WALTER P CARTER CHILD CARE CENTER INC is now grouped with WALTER P CARTER CHILD CARE CENTER, and WASHINGTON ADVENTIST UNIVERSITY is now listed as Washington Adventist University. 
...
**Answer**No, as far as I can tell the list is almost exactly the same. 
