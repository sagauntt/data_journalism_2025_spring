...
```{r echo=FALSE}
census_api_key("229e0960d50bb9e8987453834de149f058f09702", install=TRUE)
```
...
**Answer**U.S. Census data shows Howard County is richest in Maryland
...
Is the difference between Calvert and Montgomery significant? **Answer** No, since their error bars overlap. 

Is the difference between Howard and everyone else significant? **Answer** Yes, as the error bars for the county don't overlap with any others. 
...
**Answer**Baltimore city, Allegany County and Calvert County saw the largest increases in median income. No county saw their median income fall from 2020-2021. Caroline County had the lowest increase.
...
**Answer** What is the average household income of the school with the highest rate of students enrolling in college by the next fall semester? It might be harder to interpret depending on the MOE of the income variable. 
...
**Answer** There are 50 high schools that have 60% or more of their graduates immediately enrolling in college, and the average household income across those schools is 111448.3. Meanwhile, there are 76 schools with a rate of less than 40%, and those schools have an average household income of 69252.24. 
...
**Answer** What is the college enrollment rate of the top 10 schools by average household income? 
