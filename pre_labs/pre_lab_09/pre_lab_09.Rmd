...
**Answer** Copy the url of the graphic you published here. It will begin with <https://datawrapper.dwcdn.net/>. Don't copy the browser's current url: https://datawrapper.dwcdn.net/JwC32/1/ 
...
**Answer** Describe the changes from the previous map: The nearby counties in Pennsylvania, Virginia and Delaware which were previously visible are no longer included. It is only the Maryland counties on a white background. 
...
**Answer** Describe the changes from the previous map: Instead of listing the FIPS code when hovering over a county, it now shows its name. And it now also shows the pct_moore variable as a percent rather than its full decimal value. It rounds the value to a tenth. 
...
**Answer** Put the URL of your map here: https://datawrapper.dwcdn.net/3S5ma/1/ 
