...
cox_hogan <- md_gov_county |> left_join(md_gov_county_18, by="County") |> mutate(total_18=Hogan+Jealous+Quinn+Schlakman+`Write-ins.y`, total_22=Cox+Moore+Lashar+Wallace+Harding+Sefcik+`Write-ins.x`) |> mutate(pct_Cox=(Cox/total_22)*100, pct_Hogan=(Hogan/total_18)*100) 

write_csv(cox_hogan, "data/md_gov_county.csv") 
